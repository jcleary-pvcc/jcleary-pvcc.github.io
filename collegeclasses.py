...
def process_network_courses():
    global network_elect #this set mut be global since it is CHANGED in this function
    ...
    for course in network_elect:
            asterisk_course = "*" + course  #inert an asterisk in front of ELECTIVE course name
...
def process_info_courses():
    global info_elect #this set mut be global since it is CHANGED in this function
...
def display_info_courses():
    print("\nCERTIFICATE: Information Technologies")
    print(dash_line)
    print("Number of required courses   : " + str(num_info_req))
